        ...
        variations: {
            ...
            viewSigModal: {
                ...
                open: function (variationId) {
                    ...
                    if (self.data.currentVariation.signatureDocumentIds.length) {
                        ...
                        _.each(self.data.currentVariation.signatureDocumentIds, function (el, i) { //console.log(photoParams, $);
            ...
            addSigModal: {
                ...
                open: function (variationId) {
                    ...
                    //variationDetailEls.title.text(self.data.currentVariation.variationStatus);
                    //self.colorbox.instances.details.slideshows.main.slick('slickRemove', null, null, true);
                    //slideshows.carousel.slick('slickRemove', null, null, true);
                    window.setTimeout(function () {
                        _.each(self.data.currentVariation.selections, function (el) {
                            //console.log(el);
                            //slideshows.main.slick('slickAdd', '<div><img src="' + el.main + '" onload="resizeDetailsColorbox()" /></div>');
                            //slideshows.carousel.slick('slickAdd', '<div><img src="' + el.thumb + '" /></div>');
                        });
                    }, 500);
                    //variationDetailEls.description.text(self.data.currentVariation.selectedOption.name);
                    //variationDetailEls.price.text(self.data.currentVariation.selectedOption.sellPrice);
                    //variationDetailEls.packageId.data('package-id', packageId);
                    //variationDetailEls.packageId.prop('checked', $('#package-' + variationDetailEls.packageId.data('package-id')).prop('checked'));
                ...
                send: function () {
                    ...
                    var sendButton = this.$el.find('a.mh-send-approval').closest('.mh-button');
