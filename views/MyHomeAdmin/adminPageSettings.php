 ...
 * @var int                         $suggestedLoginHelpPage
...
<div class="wrap">
  ...
  <form action="<?php $this->appendFormUrl($formAttributes); ?>" id="formMyHomeAdminPage" method="POST">
    ...
    <table id="tableMyHomeAdminPage">
      ...
      <tr>
        ...
        <td>
          ...
          wp_dropdown_pages(['depth'=>0,
            ...
            'selected'=>$loginPage]);
          ?>
          <button class="button" id="buttonMyHomeAutodetectLogin" type="button"><?php _ex('Autodetect',
              'Login page option','myHome'); ?></button>
        </td>
      </tr>
      <tr>
        <td class="table-row-title"><?php _e('Login Help Page','myHome'); ?></td>
        <td>
          <?php
          wp_dropdown_pages(['depth'=>0,
            'name'=>'myHomeLoginHelpPage',
            'id'=>'selectMyHomeLoginHelpPage',
            'show_option_none'=>__('Select a Page...','myHome'),
            'option_none_value'=>'0',
            'selected'=>$loginHelpPage]);
          ?>
          <button class="button" id="buttonMyHomeAutodetectLoginHelp" type="button"><?php _ex('Autodetect',
              'Login help page option','myHome'); ?></button>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          ...
          wp_dropdown_pages(['depth'=>0,
            ...
            'option_none_value'=>'0',
            'selected'=>$mainPage,
            'exclude'=>$loginPage]); // The login page can't be the main page
          ?>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="table-row-title"><?php _e('Contact Form API Key','myHome'); ?></td>
      ...
      <tr>
        <td class="table-row-title"><?php _e('Advertising/Facebook API Key','myHome'); ?></td>
...
<script type="text/javascript">
  jQuery(function($){
    ...
    $("#buttonMyHomeAutodetectLoginHelp").click(function(){
      var suggestedLoginHelpPage=<?php echo $suggestedLoginHelpPage; ?>;
      if(suggestedLoginHelpPage!==0)
        $("#selectMyHomeLoginHelpPage").val(suggestedLoginHelpPage);
      else
        alert("<?php _e('A valid Login Help Page could not be found.','myHome'); ?>");
    })
  });
</script>
