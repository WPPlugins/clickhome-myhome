...
<div class="mh-wrapper mh-wrapper-tender-list">
  <?php foreach($filteredTenders as $tender): ?>
    <?php //var_dump($tender); ?>
    <div class="mh-block mh-block-tender">
      <?php if($tender->thumbnailUrl): ?>
        <div class="mh-section mh-section-tender-list-tender-image" style="background-image: url(<?php echo esc_url($tender->thumbnailUrl); ?>);">
