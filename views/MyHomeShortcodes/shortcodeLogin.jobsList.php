...
<div class="mh-wrapper mh-wrapper-login">
  <form action="<?php $this->appendFormUrl($formAttributesJobsList); ?>" class="mh-section mh-section-login-jobs"
    method="POST">
    <?php
    ...
    <?php endif; ?>
    <div class="mh-body mh-body-login-login-jobs">
      <div class="mh-row mh-row-login-login-jobs-email">
        <div class="mh-cell mh-cell-login-jobs-field"><?php _e('Authenticated using Facebook:','myHome'); ?></div>
        <div class="mh-cell mh-cell-login-jobs-input">
          <?php if($picture): ?>
            <?php if($picture->getHeight()&&$picture->getWidth()): ?>
              <img src="<?php echo esc_url($picture->getUrl()); ?>" style="<?php printf('height:%upx;width:%upx;',
      ...
      <div class="mh-row mh-row-login-login-jobs-job-number">
        <div class="mh-cell mh-cell-login-jobs-field"><?php _e('Job Number:','myHome'); ?></div>
        <div class="mh-cell mh-cell-login-jobs-input">
    ...
    <div class="mh-footer mh-footer-login-login">
      <div class="mh-row mh-row-login-login-button">
        <div class="mh-cell mh-cell-login-login-button">
          <button class="mh-button mh-button-login-login-submit" type="submit"><?php _e('Select Job',
              'myHome'); ?></button>
        </div>
      </div>
    </div>
