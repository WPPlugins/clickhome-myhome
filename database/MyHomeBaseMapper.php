...
abstract class MyHomeBaseMapper{
  ...
  public function find($class,array $conditions){
    return $this->doFind($this->table(),$conditions,$class,array_keys(static::$ATTRIBUTES_FORMATS),
      isset(static::$ALIASES)?static::$ALIASES:[]);
  }

  public function insertAll(array $array){
    return $this->doInsertAll($array,$this->table(),static::$ATTRIBUTES_FORMATS,
      isset(static::$ALIASES)?static::$ALIASES:[]);
  }
