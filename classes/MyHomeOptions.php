...
class MyHomeOptions{
  ...
  /**
   * Returns the LoginHelp page ID
   *
	 * @return int the LoginHelp page ID
   */
  public function getLoginHelpPage(){
	  return $this->loginHelpPage;
  }

  /**
   * Sets the LoginHelp page ID
   *
	 * @param int $loginHelpPage the LoginHelp page ID
   */
  public function setLoginHelpPage($loginHelpPage){
	  $this->loginHelpPage=(int)$loginHelpPage;
  }
...
<h4>Signature of authorised person or representative:</h4>';
  ...
  public function saveAll(){
	...
	$this->update(self::$OPTION_LOGIN_HELP_PAGE,$this->getLoginHelpPage());
  ...
  private function loadAll(){
    ...
    $this->setLoginHelpPage($this->option(self::$OPTION_LOGIN_HELP_PAGE));
    ...
    $this->setMaintenanceMaxFileSize($this->option(self::$OPTION_MAINTENANCE_MAX_FILE_SIZE,
      1.00)); // This option has a default value of 1.00 MiB
  ...
  /**
   * Login help page ID (0 if no page is set)
   *
   * @var int
   */
  private $loginHelpPage;
