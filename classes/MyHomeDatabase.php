...
class MyHomeDatabase{
  ...
  public function __construct(){
    $tableNames=['houseTypes'=>'housedetails',
...
CREATE TABLE {$this->houseTypesFacadesDocs} (
  ...
  `type` varchar(10) NOT NULL,
  `url` int(10) unsigned NOT NULL,
  PRIMARY KEY  (houseid,facadeid,url),
...
CREATE TABLE {$this->houseTypesPlanoptionsDocs} (
  ...
  `type` varchar(10) NOT NULL,
  `url` int(10) unsigned NOT NULL,
  PRIMARY KEY  (houseid,planoptionid,url),
...
CREATE TABLE {$this->displaysPlanoptionsDocs} (
  ...
  `type` varchar(10) NOT NULL,
  `url` int(10) unsigned NOT NULL,
  PRIMARY KEY  (displayid,planoptionid,url),
