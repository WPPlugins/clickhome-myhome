...
function myHomeOnInit(){
  ...
  /* Update home_url when logged in */
	...
	add_filter( 'body_class', function( $c = array() ) {
		...
		if( (isset($post->post_content) && has_shortcode( $post->post_content, 'MyHome.Login' ))) {
	...
	add_action( 'wp_head', function() {
		...
		if(!$bgImage) $bgImage = "/wp-content/themes/astrid-myhome/images/bg1.jpg";
		//$custom_css = "<base href=\"" . get_site_url() . "/\">
