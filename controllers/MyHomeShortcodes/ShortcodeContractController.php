...
class ShortcodeContractController extends MyHomeShortcodesBaseController{
   ...
   */
  protected static $FIELD_NAMES=['job'=>'Job Number',
    'clienttitle'=>'Client',
    'contactname'=>'Contact',
    'contactphone'=>'Phone',
    'contactemail'=>'Email',
  ...
  public function doShortcode(array $atts=[]){
    ...
    if($attMode==='simple'&&$attHideFields){
      myHome()->handleError('The simple mode is not compatible with providing hidden fields');
      $attMode='full';
    }
    ...
    $this->loadView('shortcodeContract','MyHomeShortcodes',compact('attMode','attHideFields','jobDetails',
      'fieldNames'));
  }
