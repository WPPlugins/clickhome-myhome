...
class ShortcodePhotosController extends MyHomeShortcodesBaseController{
  ...
  public function doShortcode(array $atts=[]){
    $atts=shortcode_atts(['columns'=>'5',
    'facebook'=>'dialog'],$atts);
    ...
    $this->loadView('shortcodePhotos','MyHomeShortcodes',compact('attColumns','photos','attFacebook','facebookAppId'));
  }
  ...
  private function photosList(){
    ...
    foreach($documents as $document){
     ...
     // if(empty($document->byclient))
      ...
      $photosList[]=['title'=>$document->title,
