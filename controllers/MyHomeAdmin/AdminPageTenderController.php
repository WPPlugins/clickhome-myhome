...
class AdminPageTenderController extends MyHomeAdminBaseController{
  ...
  public function doGet(array $params=[]){
    ...
    $this->loadView('adminPageTender','MyHomeAdmin',compact('tenderPages','suggestedTenderPages','tenderPagesDetails','skipList','declaration'));
  }
  ...
  public function doPost(array $params=[]){
    list($tenderPages, $skipList, $declaration) = $this->extractParams(['myHomeTenderPages','myHomeSkipList','myHomeTenderVariationDeclaration'],$params);
